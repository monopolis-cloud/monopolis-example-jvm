...
import verysecuresystems.oauth.SSOOAuthProvider
...
fun SecuritySystem(clock: Clock,
    ...
    val oAuthProvider = SSOOAuthProvider(oauthCallbackUri, oauthServerUri, SetHostFrom(oauthServerUri).then(timedHttp), clock)
